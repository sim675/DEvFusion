              ...
              {step === 4 && (
                ...
                >
                  <div className="flex flex-col items-center justify-center border-2 border-dashed border-white/10 rounded-3xl p-10 hover:border-violet-500/50 transition-colors bg-white/[0.02]">
                    ...
                    <h3 className="text-lg font-semibold mb-1">Upload Product Images <span className="text-red-500 text-sm font-bold">*</span></h3>
                    <p className="text-xs text-slate-500 mb-2 text-center max-w-sm">PNG, JPG up to 10MB. At least one image is required.</p>
