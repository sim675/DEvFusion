            ...
            <div className="flex-1 mx-4 hidden md:flex">
              <div className="w-full relative">
                <input
                  ...
                  className="w-full rounded-full border border-slate-300 px-5 py-2 pl-10 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-900 dark:border-slate-700 dark:text-white"
                />
            ...
            <div className="px-4 py-4 space-y-6">
              ...
              <div className="w-full relative">
                <input
                  ...
                  className="w-full rounded-full border border-slate-300 px-5 py-3 pl-11 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-slate-900 dark:border-slate-700 dark:text-white shadow-sm"
                />
